    ...
    >
      <div className="flex items-center justify-between gap-3 px-4 py-3">
        ...
        <div className="flex items-center gap-2 shrink-0">
          <span className="text-sm font-semibold text-muted-foreground tabular-nums">{cal} cal</span>
          <svg
...
export function NutritionSection({ nutrition, goals }: NutritionSectionProps) {
  ...
  return (
    <div className="mb-6">
      {/* Macro rings */}
      <Card className="p-4 mb-2.5 card-hover">
      ...
      {/* Meals */}
      {hasMeals && (
        <Card className="p-0 gap-0 overflow-hidden card-hover">
